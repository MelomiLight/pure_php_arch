...
define('DEFAULT_VALIDATION_ERRORS', [
    ...
    'exists' => 'The %s doesnt exists in %s table',
]);
...
class RequestValidator
{
     ...
     * @return bool
     */
    private function is_unique(array $data, string $field, string $table, string $column): bool
    {
        if (!isset($data[$field])) {
            return true;
        }
    ...
    private function is_exists(array $data, string $field, string $table, string $column): bool
    {
        if (!isset($data[$field])) {
            return true;
        }
